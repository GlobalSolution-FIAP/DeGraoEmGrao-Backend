...
public class EntregadorController {
	...
	@GetMapping
	public Page<Entregador> getAll(@RequestParam(required = false) String nome,
	...
	private Entregador getEntregador(Integer id) {
		return repository.findById(id).orElseThrow(() -> new RestNotFoundException("Entregador não cadastrado"));
	}
}
